param([String]$namespace = @("namespace A.Core.Scheduler")) #Must be the first statement in your script
...
$files | % {
    ...
    $currentFileContent = $currentFileContent -replace $namespace, 'namespace $rootnamespace$ //Scheduler'
