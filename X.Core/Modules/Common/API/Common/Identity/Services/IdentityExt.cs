...
{
    public static class IdentityServiceCollectionExtensions2
    {
        /// <summary>
        ...
        public static IdentityBuilder AddIdentityXCore<TUser, TRole>(
            this IServiceCollection services)
            where TUser : class
            where TRole : class
            => services.AddIdentityXCore<TUser, TRole>(setupAction: null);
