...
@Component({
  selector: 'xcore-hello-list',
  templateUrl: './xcore-hello-list.component.html',
  styleUrls: ['./xcore-hello-list.component.scss']
})
export class XCoreHelloListComponent implements OnInit, AfterViewInit {
      ...
      private async searchInternal() {
          ...
          this.searchResult.list = result.resultList;
      ...
      details(row) {
          this.router.navigate(['/test', { id: row.id }]);
      }
