...
@Component({
    selector: 'xcore-hello-list3',
    templateUrl: './xcore-hello-list3.component.html',
    styleUrls: ['./xcore-hello-list3.component.scss']
})
export class XCoreHelloList3Component implements OnInit, AfterViewInit {
    ...
    async ngOnInit() {
        this.pageTitleService.setTitle("Views." + "hello");
        await this.init();
    }
